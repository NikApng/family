...
function PersonCard({ name, role, exp, badge, tint }: PersonCardProps) {
  const bg =
      tint === "indigo"
          ? "from-white to-indigo-50/70 border-indigo-100 hover:border-indigo-200"
          : tint === "rose"
  ...
  return (
      <div
          className={`group relative overflow-hidden rounded-3xl border bg-gradient-to-b p-7 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${bg}`}
      >
          ...
          <Section title="Наши специалисты" subtitle="Психологи и волонтёры с опытом кризисной помощи.">
            <div className="grid gap-6 md:grid-cols-3">
              <PersonCard
                  ...
                  exp="Кризисная помощь, работа с тревогой, утратой и шоковыми состояниями. Тёплый, внимательный подход."
              ...
              <PersonCard
                  name="Ирина С."
                  role="Психотерапевт"
                  exp="Индивидуальная терапия, восстановление устойчивости, сопровождение в сложных жизненных ситуациях."
                  badge="Индивидуальная работа"
                  tint="rose"
              />
              <PersonCard
                  name="Команда волонтёров"
                  role="Сопровождение"
                  exp="Бережная коммуникация, помощь с организацией и поддержка между встречами, если это необходимо."
                  badge="Поддержка рядом"
                  tint="amber"
              />
            </div>
          </Section>
        ...
        <BackdropSection id="reviews" variant="c">
          <Section title="Отзывы клиентов" subtitle="Реальные истории благодарности — можно публиковать анонимно.">
            <div className="grid gap-6 md:grid-cols-3">
              <TestimonialCard
                  tint="rose"
                  text="Спасибо за поддержку и спокойный разговор. Стало легче дышать."
                  author="Анонимно"
              />
              <TestimonialCard
                  tint="indigo"
                  text="После встреч появилась опора и понимание, что делать дальше."
                  author="Елена"
              />
              <TestimonialCard
                  tint="amber"
                  text="Очень бережный подход. Без давления и лишних вопросов."
                  author="Анонимно"
              />
            </div>
          </Section>
        ...
        <section className="relative overflow-hidden border-t border-indigo-100">
          ...
          <div className="mx-auto w-full max-w-6xl px-4 py-14">
            <div className="relative overflow-hidden rounded-3xl border border-indigo-100 bg-white p-8 shadow-sm md:flex md:items-center md:justify-between">
              ...
              <div className="relative">
                <div className="text-2xl font-semibold tracking-tight text-gray-900">Поддержка рядом. Сделайте первый шаг.</div>
